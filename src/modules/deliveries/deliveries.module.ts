...
import { GetActiveDeliveriesHandler } from '@deliveries/application/queries/get-active-deliveries/get-active-deliveries.handler'
...
const QueryHandlers = [GetDeliveryByTokenHandler, GetActiveDeliveriesHandler]
...
@Module({
  ...
  exports: [DELIVERY_LINK_WRITE_REPOSITORY, DELIVERY_LINK_READ_REPOSITORY],
})
